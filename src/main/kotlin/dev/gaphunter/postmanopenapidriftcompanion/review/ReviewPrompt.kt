package dev.gaphunter.postmanopenapidriftcompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.postmanopenapidriftcompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.postmanopenapidriftcompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Postman OpenAPI Drift Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33815-postman-openapi-drift-companion/reviews"
